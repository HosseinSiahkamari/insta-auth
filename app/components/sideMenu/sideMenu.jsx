        ...
        <div className=" h-screen">
            ...
            <div className=''>
                <div className='flex items-center w-64 h-10 ml-2 mt-4' >
                    <HomeIcon className='w-5 h-5 ml-5' />
                    <p className='xl:block md:ml-5 hidden'>Home</p>
                </div>
                <div className='flex items-center w-64 h-10 ml-2 mt-4' >
                    <MagnifyingGlassIcon className='w-5 h-5 ml-5' />
                ...
                <div onClick={signInHandler} className='flex items-center w-64 h-10 ml-2 mt-4 cursor-pointer' >
